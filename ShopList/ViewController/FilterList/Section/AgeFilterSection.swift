...
final class AgeFilterSection: FilterBaseSection {
    ...
    override func createLayout(itemCount: Int = 0) -> NSCollectionLayoutSection? {
        ...
        let group = NSCollectionLayoutGroup.horizontal(layoutSize: itemSize, subitem: item, count: 4)
